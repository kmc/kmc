...
describe Kmc::DownloadUrl do
  ...
  it 'detects dropbox links' do
    ...
    expect(Kmc::DownloadUrl.new(url)).to be_dropbox
  end
  ...
  it 'detects curseforge links' do
    ...
    expect(Kmc::DownloadUrl.new(url)).to be_curseforge
  end
